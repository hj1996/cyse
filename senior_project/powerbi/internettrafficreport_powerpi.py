...
def internettrafficreport():
	...
	try:
		...
		print tables
		tables.to_csv(os.path.expanduser("~/Documents/senior_project/data/"+"internettrafficreport-_"+str(date)+".csv"),index=False)
		return tables
	except ValueError:
		pass

internet_traffic_report_current=internettrafficreport()